...
ip_config = KeyboardButton('Узнать айпи')
start_command = ReplyKeyboardMarkup(resize_keyboard=True).add(temp_button, process,user_list, reload, shotdown,ip_config)
